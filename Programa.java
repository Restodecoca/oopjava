...
public class Programa {
	...
	public static void main(String[] args) {
		...
		Estadio e1 = new Estadio(ed1, "São januario");
		...
		Estadio e3 = new Estadio(ed3, "Maracanã");
		...
		while (true) {
		    ...
		    System.out.println("1 - Ver as partidas ocorridas e que irão ocorrer");
		    System.out.println("2 - Listar a tabela do campeonato apresentando os times em ordem");
		    System.out.println("3 - Criar novo time");
		    System.out.println("4 - Criar nova partida");
		    ...
		    switch (opcao) {
		        ...
		        case 2:
		            List<Time> tabelaCampeonato = c1.listarTabelaDoCampeonato();
		        ...
		        case 3:
		            ...
		            // Criando o endereço
		            System.out.print("Digite o endereço (String rua, Integer número, String nome do bairro, String nome da cidade): ");
		            ...
		            do {
		                ...
		                switch (opcaoJogadores) {
		                    case 1:
		                        System.out.print("Digite os dados do jogador (nome, data de nascimento no formato aaaa-mm-dd, gênero, altura): ");
		                    ...
		                    case 2:
		                        System.out.println("Saindo do menu de criação de jogadores.");
		                        break;
		            ...
		            System.out.print("Digite o nome do jogador capitão: ");
